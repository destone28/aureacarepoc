...
window.MOCK = (function () {
  ...
  const structures = [
    { id: 'STR-001', name: 'Policlinico A. Gemelli (privato universitario)', type: 'Privato convenzionato', area: 'Roma Nord-Ovest', address: 'Largo A. Gemelli 8',  district: 'Trionfale',     lat: 41.9281, lng: 12.4319, distance_km: 4.2, rating: 4.7, reviews: 1284, specialties: ['Cardiologia','Oncologia','Dermatologia','Ortopedia','Ginecologia','Neurologia'], next_slot: 'Domani, 10:30', cert: 'JCI', listing_verified: true, weekly_open: '08:00 – 20:00', active: true },
    { id: 'STR-002', name: 'Roma East Private Hospital',                 type: 'Privato convenzionato', area: 'Roma Sud-Est',  address: 'Viale Oxford 81',     district: 'Tor Vergata',   lat: 41.8517, lng: 12.6191, distance_km: 9.6, rating: 4.4, reviews: 642,  specialties: ['Ortopedia','Riabilitazione','Cardiologia','Diabetologia'], next_slot: 'Mar 27 mag, 09:00', cert: 'ISO 9001', listing_verified: true, weekly_open: '08:00 – 19:00', active: true },
  ...
  const bookings = [
    ...
    { id: 'BOOK-094', service_id: 'SRV-V05', service_name: 'Visita oculistica',     structure_id: 'STR-003', structure_name: 'Villa Gianicolense',         date: '02 mag', time: '15:00', cost: 70, status: 'cancelled', shuttle: false, doctor: 'Dr. Paolo Sini' },
  ...
  const admin_requests = [
    ...
    { id: 'REQ-2026-0138', patient: 'Sofia Ferri',      cf: 'FRRSFO88P54H501M', service: 'Visita oculistica',       structure: 'Villa Gianicolense',         date: '26 mag · 15:30', submitted: '19 mag 17:32', cost: 75,  wallet_after: 220, status: 'approved' },
    ...
    { id: 'REQ-2026-0135', patient: 'Davide Greco',     cf: 'GRCDVD80E21H501Y', service: 'Visita pneumologica',     structure: 'Villa Gianicolense',         date: '22 mag · 09:30', submitted: '18 mag 16:43', cost: 90,  wallet_after: 165, status: 'rejected' },
    { id: 'REQ-2026-0134', patient: 'Elena Riva',       cf: 'RVELNE76C44H501R', service: 'Ciclo dialisi (mensile)', structure: 'Roma East Private Hospital',           date: '21 mag · 08:00', submitted: '18 mag 12:08', cost: 1100,wallet_after: 25,  status: 'approved' },
